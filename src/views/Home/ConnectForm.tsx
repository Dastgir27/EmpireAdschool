...
export default function ConnectForm() {
  ...
  return (
    ...
    >
      {/* Right-Aligned Form */}
      <div className="w-full max-w-xl bg-[#FFF3EB] bg-opacity-95 rounded-3xl shadow-2xl p-10 ml-auto">
  <h3 className="text-3xl font-semibold text-center text-[#5A2E1A]">Connect with Us</h3>
  <form className="mt-8 space-y-5">
    ...
    <div className="flex items-center">
      ...
      />
      <label className="ml-3 text-[#8A3E1B] text-sm">
